...
results shows that the most frequently used words in all speeches include "freedom"."constitute","ideal","public","law","tariff", and in Donald Trump's speech it includes "job","back","dream","everyone". The results shows the main policy Mr.Trump is holding.
```{r}
par(mfrow=c(1,1))
